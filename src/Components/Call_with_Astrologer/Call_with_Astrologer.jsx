...
const Call_with_Astrologer = () => {
  ...
  return (
    <>
      <SEO
        title="Talk to Astrologer Online, Consult Highly Experienced Jyotish on Call"
        description="Connect with top-rated astrologers online and get personalized insights into your life. Talk to astrologers now for guidance and clarity."
        keywords="talk to astrologer on phone,talk to astrologer online,talk to pandit ji online,online talk to astrologer,talk to best astrologer,talk to jyotish online,talk to astrologer,astrology talk online,live talk with astrologer,online astro talk"
                              ...
                              <div className="btn astro-meet-btn-call">
                                {data.is_voice_online === "off" ? (
                                  ...
                                  <>
                                    ...
                                    <button
                                      className="btn_chat online-status mr-2"
